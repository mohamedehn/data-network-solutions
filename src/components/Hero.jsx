...
export default function Hero() {
  ...
  return (
      ...
      <main>
        <div className="relative isolate">
          ...
          <div className="overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-6 sm:pt-5 lg:px-8 lg:pt-5">
    ...
    //                       Data Network Solutions
    //                       <br/><span className="text-[#3150f8]"> IT - TELECOM - ENGINEERING</span>
    //                   </h1>
    //                  <p className="text-gray-300 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
    //                   L'étape la plus importante pour une entreprise, est de passer à la suivante.
    //                   </p>
    //                   <div className="pt-10 items-center justify-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex lg:justify-start">
    //                       <a href="#contact" className="px-7 py-3 w-full bg-white text-gray-800 text-center rounded-md shadow-md block sm:w-auto hover:bg-[#3150f8]">
    //                           Nous contacter
    //                       </a>
    //                   </div>
    //               </div>
